const button_group_template = document.createElement('template');
button_group_template.innerHTML = `
  <style>
    .ripple {
      position: relative;
      overflow: hidden;
...
class RippleButtonGroup extends HTMLElement {
  ...
  constructor () {
    ...
    this.shadowRoot.appendChild(button_group_template.content.cloneNode(true));
  }
